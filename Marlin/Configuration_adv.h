...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {180*60, 180*60, 30*60, 5*60} // Feedrates for manual moves along X, Y, Z, E from panel
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH 1.4              // Default retract length (positive mm)
